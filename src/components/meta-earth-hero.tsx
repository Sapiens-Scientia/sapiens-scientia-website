...
// The Meta Earth hero: the homepage journey's Current Sunlight globe attended
// by its two moons — the real Moon at its true place in the sky, and the
// digital moon, earth's digital systems as a made moon raising a second tide
// — under the Meta Earth overlay chrome. It opens from the same constant
// camera as the journey's finale, so "enter meta earth" reads as the overlays
// changing over an unmoved globe while the digital moon materializes.
